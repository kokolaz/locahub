//penambahan listaddress2 biar address yg di halaman profil bisa diarahin ke editaddress
import 'dart:convert';
...
import 'package:locahub/core/views/address/view/edit_address.dart';
import 'package:locahub/core/views/checkout/checkout_2/view/checkout_2_view.dart';
import 'package:locahub/core/views/global/theme.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ListAddress2 extends StatefulWidget {
  final String token;
  final int? userId;

  const ListAddress2({Key? key, required this.token, this.userId})
      : super(key: key);

  @override
  State<ListAddress2> createState() => _ListAddress2State();
}

class _ListAddress2State extends State<ListAddress2> {
...
// Save the string to shared preferences
        ...
        await prefs
            ...
            .then((value) => Get.to(() => const EditAddress()));
        //Get.back());
      },
      child: Container(
